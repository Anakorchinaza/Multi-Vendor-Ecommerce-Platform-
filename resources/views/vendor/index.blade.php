...
@section('vendor')
    ...
    <div class="page-content">
        ...
        @if ($status === 'active')
            <h4>{{$vendor_id->name}} Account is <span class="text-success">Active</span></h4>
        @else
            <h4>{{$vendor_id->name}} Account is <span class="text-danger">InActive</span></h4>
            <P class="text-danger"><strong>Please wait for admin to verify and approve your account.</strong></P>
        @endif
