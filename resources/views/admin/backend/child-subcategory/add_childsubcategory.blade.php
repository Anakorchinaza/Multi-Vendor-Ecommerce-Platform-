            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Child Sub-Category</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <form action="{{route('insert_child_subcategory')}}" method="post" id="brandForm">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="child_subcategory_name" id="child_subcategory_name" class="form-control" value="" />
    ...
    {{-- <script type="text/javascript">
        $(document).ready(function(){
            $('#category').on('change', function() {
                ...
                $.ajax({
                    url: '/get-subcategories/' + parentCategoryId,
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        ...
                        $.each(data, function(index, subcategory) {
                            subcategoryDropdown.append($('<option>').text(subcategory.subcategory_name).attr('value', subcategory.id));
                        });
                    }
                });
            });
