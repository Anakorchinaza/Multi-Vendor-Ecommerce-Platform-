        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <form action="{{route('store_slider')}}" method="post" id="brandForm" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="frs_title" id="frs_title" class="form-control" value="{{ old('frs_title') }}" />
                                            @error('frs_title')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="sec_tile" id="sec_tile" class="form-control" value="{{ old('sec_tile') }}" />
                                            @error('sec_tile')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="small_desc" id="small_desc" class="form-control" value="{{ old('small_desc') }}" />
                                            @error('small_desc')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
