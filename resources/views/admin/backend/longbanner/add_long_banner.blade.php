            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Long Banner</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <form action="{{route('store.long.banner')}}" method="post" id="brandForm" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            ...
                                            <div class="form-text">Discount in Percentage(%).</div>
                                            @error('discount')
