            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Short Banner</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <form action="{{route('store.short.banner')}}" method="post" id="brandForm" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">                                   
