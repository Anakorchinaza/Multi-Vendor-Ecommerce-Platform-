            ...
            <div class="tab tab-vertical row gutter-lg">
                ...
                <div class="tab-content mb-6">
                        ...
                        <form action="{{route('user.update_profile')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="name" name="name" placeholder="John Doe"
                                    class="form-control form-control-md mb-0" value="{{ $userData->name }}">
                                @error('name')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" name="email" placeholder="doe@gmail.com" value="{{ $userData->email }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="phone" id="phone" name="phone" placeholder="+234 XXXXXXX" value="{{ $userData->phone }}"
                                            class="form-control form-control-md">
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                            ...
                            <div class="form-group mb-6">
                                ...
                                <img class="rounded avatar-lg shadow-sm mt-3" id="showImage" 
                                src="{{(!empty($userData->image)) ? url('upload/user_images/'.$userData->image) : url('upload/no_image.jpg') }}" alt="image" style="height: 100px; ">
                            </div>
                    ...
                    <div class="tab-pane" id="change-password">
                        <div class="icon-box icon-box-side icon-box-light mb-5">
                            <span class="icon-box-icon icon-account mr-2">
                                <i class="w-icon-user"></i>
                            </span>
                            <div class="icon-box-content">
                        ...
                        <form action="{{route('user.update_password')}}" method="post" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form-control-md @error('old_password') is-invalid @enderror"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form-control-md @error('new_password') is-invalid @enderror"
                            ...
                            <button type="submit" class="btn btn-dark btn-rounded btn-sm mb-4">Update Password</button>
                        </form>
                    </div>
                </div>
            </div>
