        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="form-body mt-4">
                    <form action="{{route('update.product')}}" method="post" id="brandForm">
                        @csrf
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="single-select" name="vendor_id">
                                                ...
                                                @foreach ($all_active_vendor as $vendor)
                                                    <option value="{{ $vendor->id }}" {{ $vendor->id == $all_products->vendor_id ? 'selected' : '' }}>{{ ucfirst(strtolower($vendor->name)) }}</option>                                            
                                                @endforeach
                                            </select>                                            
                                        </div>
        ...
        <div class="card">
            <div class="card-body">
                <table class="table mb-0 table-striped">
                    ...
                    <tbody>
                        <form action="{{route('update.product.multiimg')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @php $sn = 0; @endphp
                            @foreach ($multi_imgs as $imgs)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('product.multi-img.delete', $imgs->id) }}" id="delete" class="delete text-center" title="Delete">
