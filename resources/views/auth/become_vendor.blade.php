...
<head>
    ...
    <title>Become A Vendor - Fashion Mall</title>
                    ...
                    <div class="login-popup">
                        <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                            <ul class="nav nav-tabs text-uppercase" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link active">Vendor Sign Up</a>
                                </li>
                            </ul>
                                    ...
                                    <div class="tab-pane active" id="sign-up">
                                        <div>
                                            ...
                                            <div class="form-group mb-5">
                                                ...
                                                <input type="date" class="form-control" name="vendor_joined" value="{{ old('vendor_joined') }}" required>
                                                <x-input-error :messages="$errors->get('vendor_joined ')" class="mt-2" />
                                            </div>
                                            ...
                                            <div class="form-group mb-5">
                                                ...
                                                <input type="password" name="password_confirmation" class="form-control" value="{{ old('password_confirmation') }}" id="password_confirmation"  required>
                                        ...
                                        <div class="form-checkbox d-flex align-items-center justify-content-between mb-5">
                                            ...
                                            <span>Already have an account? <a href="{{ route('vendor.login') }}" class="text-primary">Vendor Login</a></span>
                                        </div>
